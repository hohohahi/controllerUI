...
@Service
public class StartCommandSender extends AbstractBaseSerialManager {
	@Autowired
	...
	public void onReceive(final RxTxResponseVO responseVO) {
		...
		vo.setSubMessageType(SubMessageTypeEnum._SubMessageType_PlayerPanel_StartCommandButton_);
