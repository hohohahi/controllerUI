...
public class PlayerPanel extends JPanel implements IMessageListener{
	...
	public void initProductionList() {
		...
		productionDataVO.setBarCode("6954767415773");
		...
		productionDataVO = new ProductionDataVO();												
		productionDataVO.setTimestampStr("123456");
		productionDataVO.setBarCode("3179730110796");
		productionDataVO.setTemplateName("perrier300ml");
		productionDataVO.setIsSuccessful(true);	
		...
		productionDataVO = new ProductionDataVO();												
		productionDataVO.setTimestampStr("123456");
		productionDataVO.setBarCode("6925303730574");
		productionDataVO.setTemplateName("tongyiasamu500ml");
		productionDataVO.setIsSuccessful(true);	
		...
		productionDataVO = new ProductionDataVO();												
		productionDataVO.setTimestampStr("123456");
		productionDataVO.setBarCode("4891028706656");
		productionDataVO.setTemplateName("weitaningmengcha310ml");
		productionDataVO.setIsSuccessful(true);	
		...
		productionDataVO = new ProductionDataVO();												
		productionDataVO.setTimestampStr("123456");
		productionDataVO.setBarCode("6902538004045");
		productionDataVO.setTemplateName("maidong600ml");
		productionDataVO.setIsSuccessful(true);	
